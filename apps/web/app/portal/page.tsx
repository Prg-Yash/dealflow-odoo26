...
function CustomerPortalContent() {
  ...
  // Fill in default customer info when quote loads
  useEffect(() => {
    if (quote?.customer) {
      ...
      <div className="min-h-screen bg-[#f8fafc] text-slate-900 flex flex-col justify-between">
        ...
        <main className="max-w-md mx-auto w-full px-6 py-20 flex-1 text-center">
          ...
          <p className="text-sm text-slate-500 mt-2">
            The quote reference <strong>{token}</strong> could not be located or has expired. Please check your invitation link or enter your quote code below.
          </p>
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans antialiased flex flex-col justify-between">
      ...
      <main className="max-w-5xl mx-auto w-full px-6 py-8 flex-1 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 p-6 sm:p-8 shadow-xs text-left">
          ...
          <div className="pt-5 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            {/* Quick Confirm & Negotiate CTA if not confirmed */}
            {!isConfirmed && (
            ...
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Expand any line item to ask specific questions or request quantity / tier adjustments.
                </p>
              </div>
                        ...
                        <div className="mt-4 pt-4 border-t border-slate-100 bg-slate-50/70 -mx-5 -mb-5 p-5 rounded-b-2xl space-y-3">
                          ...
                          <div className="flex items-center gap-2 pt-1">
                            <input
                              ...
                              className="flex-1 bg-white border border-slate-200 rounded-xl px-3.5 py-2 text-xs text-slate-900 focus:border-[#ff5e3a] focus:ring-1 focus:ring-orange-100 outline-none"
                            />
                            <button
          ...
          <div className="bg-white rounded-2xl border border-slate-200/90 shadow-xs overflow-hidden text-left">
            ...
            <form onSubmit={handleAddGeneralComment} className="p-4 bg-slate-50 border-t border-slate-200 flex gap-2">
              <input
                ...
                className="flex-1 bg-white border border-slate-200 rounded-xl px-4 py-2.5 text-xs text-slate-900 focus:border-[#ff5e3a] focus:ring-1 focus:ring-orange-100 outline-none"
              />
              <button
                type="submit"
      ...
      {/* MODAL 1: Counter Proposal / Discount Negotiation Modal */}
      {showCounterModal && (
            ...
            <form onSubmit={handleCounterProposalSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g. We have a strict Q1 departmental budget cap of $40,000. If approved, we will execute today."
                  className="w-full bg-white border border-slate-200 rounded-xl p-3 text-xs text-slate-900 focus:border-[#ff5e3a] focus:ring-1 focus:ring-orange-100 outline-none"
                />
              </div>
      ...
      {/* MODAL 2: E-Signature Legal Execution Modal */}
      {showSignModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-xs p-4">
